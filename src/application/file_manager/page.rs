// extern crate byteorder;
    ...
    impl Page {
        pub fn new(buffer_size: u64) -> Page{
            ...
            let buffer = Cursor::new(vec![0 as u8;buffer_size as usize]);
            Page{
                buffer: buffer,
            }
    ...
    mod page_test {
        ...
        fn test_bytes(){
            ...
            page.write_bytes(40, test_string.as_bytes()).unwrap();
